...
export interface ICoreHandlers {
  ...
  updateCookbook(ctx: RequestContext, id: string, data: { name?: string; description?: string; coverImage?: string | null; isPublic?: boolean }): Promise<ApiResult<{ success: boolean }>>;
