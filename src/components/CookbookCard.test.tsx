...
describe('CookbookCard', () => {
  ...
  it('shows delete button for owner with onDelete', () => {
    render(
      <CookbookCard
    ...
    expect(screen.getByLabelText('Delete cookbook')).toBeDefined();
  });

  it('hides delete button for non-owner', () => {
    const sharedCookbook = { ...mockCookbook, isOwner: false };
    render(
      <CookbookCard
    ...
    expect(screen.queryByLabelText('Delete cookbook')).toBeNull();
  });
  ...
  it('calls onDelete when delete clicked and confirmed', () => {
    ...
    fireEvent.click(screen.getByLabelText('Delete cookbook'));
    // Confirm modal should appear
    expect(screen.getByText('Delete Cookbook')).toBeDefined();
  ...
  it('does not trigger onClick when delete clicked', () => {
    const onClick = vi.fn();
    render(
      <CookbookCard
        cookbook={mockCookbook}
